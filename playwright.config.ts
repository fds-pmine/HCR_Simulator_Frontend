...
export default defineConfig({
  ...
  // with a software rasteriser starved the renderer badly enough to lose the
  // browser mid-test ("Protocol error … session closed"), so CI takes the
  // stability over the wall-clock.
